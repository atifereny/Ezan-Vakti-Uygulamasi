...
class PrayerWidgetDark : HomeWidgetProvider() {

    companion object {
        private const val PREFS_NAME   = "HomeWidgetPreferences"
        private val COLOR_ACTIVE       = Color.parseColor("#C49A5C")
        private val COLOR_NORMAL       = Color.parseColor("#F5EDD6")
    ...
    private fun updateWidget(
        ...
        val layout = if (minWidth >= LARGE_WIDTH) R.layout.prayer_widget_dark_large else R.layout.prayer_widget_dark
        ...
        // Yenile butonu
        val refreshIntent = Intent(context, PrayerWidgetDark::class.java).apply {
